...
public class Fragment_andr extends Fragment {

    private final String address="http://gank.io/api/data/Android/50/1";
    private static final String TAG="------"+Fragment_andr.class.getSimpleName()+"------";
